...
export const MAPS: { [key: string]: GameMap } = {
	home: {
		...
		tiles: [
			{ type: 'killer', x: 0, y: 0, w: 110, h: 10 },
			{ type: 'killer', x: 0, y: 100 - 10, w: 110, h: 10 },
			// { type: 'killer', x: 0, y: 0, w: 10, h: 100 },
			// { type: 'killer', x: 100 - 10, y: 0, w: 10, h: 100 },

			{ type: 'victory', w: 40, h: 15, x: 10, y: 0, goto: 'tutorial-1', text: 'TUTORIAL' },
			{ type: 'victory', w: 40, h: 15, x: 70, y: 20, goto: 'DEFAULT', text: 'DEFAULT' },
			{ type: 'victory', w: 40, h: 15, x: 70, y: 40, goto: 'DEFAULT2', text: 'DEFAULT2' },
			{ type: 'victory', w: 40, h: 15, x: 70, y: 60, goto: 'level-3', text: 'LEVEL3' },
		],
	},
	'level/test': genmap(),
	'tutorial-1': {
		...
		tiles: [
			...
			{ type: 'victory', x: 80, y: 60, w: 20, h: 20, goto: 'tutorial-2' },
		],
	},
	'tutorial-2': {
		challenge: true,
		...
		tiles: [
			...
			{ type: 'killer', y: 0, x: 0, h: 130, w: 10 },
			{ type: 'killer', y: 0, x: 120, h: 130, w: 10 },
			{ type: 'killer', x: 0, y: 130, w: 130, h: 10 },
			{ type: 'killer', x: 40, y: 50, w: 10, h: 10 },
			{ type: 'checkpoint', x: 40, y: 25, w: 10, h: 10 },
			{ type: 'killer', x: 30, y: 100, w: 10, h: 10 },
			{ type: 'checkpoint', x: 80, y: 110, w: 10, h: 10 },
			{ type: 'killer', x: 80, y: 50, w: 10, h: 50 },
			{ type: 'victory', x: 120, y: 55, w: 10, h: 30, goto: 'home' },
		],
	},
	'level-3': {
		challenge: true,
